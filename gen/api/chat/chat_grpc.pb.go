...
type ChatServiceClient interface {
	...
	GetChatMessages(ctx context.Context, in *ChatRequest, opts ...grpc.CallOption) (*ChatResponse, error)
}
...
func (c *chatServiceClient) GetChatMessages(ctx context.Context, in *ChatRequest, opts ...grpc.CallOption) (*ChatResponse, error) {
...
type ChatServiceServer interface {
	// チャットメッセージをリクエストしてレスポンスを得るメソッド
	GetChatMessages(context.Context, *ChatRequest) (*ChatResponse, error)
...
func (UnimplementedChatServiceServer) GetChatMessages(context.Context, *ChatRequest) (*ChatResponse, error) {
...
func _ChatService_GetChatMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetChatMessages(ctx, req.(*ChatRequest))
	}
